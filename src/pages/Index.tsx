  ...
  return <div className="space-y-4 sm:space-y-6 max-w-7xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {modules.map(module => <Card key={module.id} className="hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:-translate-y-1 border-gray-200" onClick={() => navigate(module.route)}>
