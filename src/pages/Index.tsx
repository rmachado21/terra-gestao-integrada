...
const Index = () => {
  ...
  return <div className="space-y-4 sm:space-y-6 max-w-7xl mx-auto">
      {/* Header padronizado */}
      ...
      animationDelay: '0.2s'
        ...
        <h2 className="text-lg font-semibold text-gray-800 sm:text-lg">Acesso Rápido</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {modules.map((module, index) => <Card key={module.id} className="hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:-translate-y-1 border-gray-200 animate-scale-in" style={{
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 animate-fade-in" style={{
      animationDelay: '0.7s'
    }}>
        <RecentActivities />
        <AlertsPanel />
