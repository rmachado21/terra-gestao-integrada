...
export const AuthLayout = ({ children, isBlocked }: AuthLayoutProps) => {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-900 to-slate-950 flex items-center justify-center p-4">
