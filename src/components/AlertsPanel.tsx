    ...
    return <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {[...Array(5)].map((_, i) => <div key={i} className="animate-pulse p-3 rounded-lg border">
  ...
  return <Card>
      ...
      <CardContent>
        <div className="space-y-3">
          ...
          return <div key={alert.id || index} className={`p-3 rounded-lg border cursor-pointer hover:shadow-md transition-all ${getPriorityColor(priority)}`} onClick={() => handleAlertClick(alert)}>
